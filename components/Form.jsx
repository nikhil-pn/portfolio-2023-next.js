...
const Form = () => {
  ...
  const formSubmitHandler = (e) => {
    ...
    send(
      "service_2leuuht", // Service ID
      "template_6qjnwys", // Template ID
      userInput,
      "-2GRFEvEWeZomqAgP" // Public Key - https://dashboard.emailjs.com/admin/account
    )
      .then((response) => {
  ...
  return (
    <Div className="max-w-[1200px] mx-auto">
      ...
      >
        ...
        {/* SUBMIT BUTTON */}
        <button className="bg-[#111111] rounded-none h-[64px] w-full  justify-center text-[16px] text-white  transition-transform active:scale-[0.95]">
